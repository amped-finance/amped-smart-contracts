...
interface YieldBearingALPVaultV3Interface extends ethers.utils.Interface {
  functions: {
...
export class YieldBearingALPVaultV3 extends BaseContract {
  ...
  interface: YieldBearingALPVaultV3Interface;
