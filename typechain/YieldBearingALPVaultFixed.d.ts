...
interface YieldBearingALPVaultFixedInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "SetMaxSlippage(uint256)": EventFragment;
...
export type SetFeeRecipientEvent = TypedEvent<
  [string] & { feeRecipient: string }
>;

export type SetGovEvent = TypedEvent<[string] & { gov: string }>;

export type SetKeeperEvent = TypedEvent<[string] & { keeper: string }>;

export type SetMaxSlippageEvent = TypedEvent<
  [BigNumber] & { maxSlippage: BigNumber }
>;

export type SetPerformanceFeeEvent = TypedEvent<
...
export class YieldBearingALPVaultFixed extends BaseContract {
  ...
  interface: YieldBearingALPVaultFixedInterface;
  ...
  filters: {
    ...
    "Compound(uint256,uint256,uint256)"(
      ...
      [BigNumber, BigNumber, BigNumber],
      { wethAmount: BigNumber; alpGained: BigNumber; performanceFee: BigNumber }
    >;
    ...
    "SetGov(address)"(gov?: null): TypedEventFilter<[string], { gov: string }>;

    SetGov(gov?: null): TypedEventFilter<[string], { gov: string }>;

    "SetKeeper(address)"(
      keeper?: null
    ): TypedEventFilter<[string], { keeper: string }>;

    SetKeeper(keeper?: null): TypedEventFilter<[string], { keeper: string }>;

    "SetMaxSlippage(uint256)"(
      maxSlippage?: null
    ): TypedEventFilter<[BigNumber], { maxSlippage: BigNumber }>;
