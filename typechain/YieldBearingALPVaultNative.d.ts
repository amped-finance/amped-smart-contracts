...
interface YieldBearingALPVaultNativeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "withdrawToken(uint256,address,uint256,address)": FunctionFragment;
  };
...
export class YieldBearingALPVaultNative extends BaseContract {
  ...
  interface: YieldBearingALPVaultNativeInterface;
