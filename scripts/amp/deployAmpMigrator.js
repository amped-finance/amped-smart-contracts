...
async function main() {
  ...
  const ampMigrator = await deployContract("AmpMigrator", [2])
  const gmtAmpIou = await deployContract("AmpIou", [ampMigrator.address, "GMT AMP (IOU)", "GMT:AMP"])
  const xgmtAmpIou = await deployContract("AmpIou", [ampMigrator.address, "xGMT AMP (IOU)", "xGMT:AMP"])
  const gmtUsdgAmpIou = await deployContract("AmpIou", [ampMigrator.address, "GMT-USDG AMP (IOU)", "GMT-USDG:AMP"])
  const xgmtUsdgAmpIou = await deployContract("AmpIou", [ampMigrator.address, "xGMT-USDG AMP (IOU)", "xGMT-USDG:AMP"])
  ...
  const ampPrice = bigNumberify(2 * precision)
  ...
  const iouTokens = [gmtAmpIou.address, xgmtAmpIou.address, gmtUsdgAmpIou.address, xgmtUsdgAmpIou.address]
