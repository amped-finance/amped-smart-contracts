...
async function deploy_basesepolia() {
  ...
  syncDeployInfo("cbbtc", { name: "cbbtc", imple: "0x529FCB9442701174a0D55D8DD536E5c3815a429B" });
  ...
  syncDeployInfo("GMX", { name: "GMX", imple: "0xd1Af6E098F7ee3282578862C3285F754D0128a6f" });
...
module.exports = { deploy_basesepolia };
