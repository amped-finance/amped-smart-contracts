...
module.exports = {
  ...
  sonic: {
    usdc: {
      ...
      minProfitBps: 20,
      maxUsdgAmount: 20000,
      bufferAmount: 5000000000,
      isStable: true,
      isShortable: false,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.1 * 10 * 1000 * 1000,
      maxGlobalLongSize: 30 * 1000 * 1000,
      maxGlobalShortSize: 15 * 1000 * 1000,
      openInterestLimitLong: 80 * 1000 * 1000,
      openInterestLimitShort: 50 * 1000 * 1000,
    ...
    ws: {
      ...
      tokenWeight: 10000,
      minProfitBps: 20,
      maxUsdgAmount: 2000000,
      bufferAmount: "75000000000000000000000",
      isStable: false,
      isShortable: true,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.1 * 10 * 1000 * 1000,
    ...
    sts: {
      ...
      decimals: 18,
      priceFeed: "0x7a2f48289d0CaeB5229253047e3fc7210A661682",
      priceDecimals: 8,
      stable: false,
      tokenWeight: 4000,
      minProfitBps: 20,
      maxUsdgAmount: 70000,
      bufferAmount: "15000000000000000000000",
      isStable: false,
      isShortable: true,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.1 * 10 * 1000 * 1000,
    ...
    weth: {
      ...
      tokenWeight: 6000,
      minProfitBps: 20,
      maxUsdgAmount: 1000000,
      bufferAmount: "10000000000000000000",
      isStable: false,
      isShortable: true,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.1 * 10 * 1000 * 1000,
    ...
    shadow: {
      ...
      decimals: 18,
      priceFeed: "0xEb2792e1A1648Fd6a1CCe142A665b02D8E129629",
      priceDecimals: 8,
      stable: false,
      tokenWeight: 2000,
      minProfitBps: 20,
      maxUsdgAmount: 25000,
      bufferAmount: "200000000000000000000",
      isStable: false,
      isShortable: true,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.1 * 10 * 1000 * 1000,
    ...
    anon: {
      ...
      minProfitBps: 20,
      maxUsdgAmount: 25000,
      bufferAmount: "250000000000000000000",
      isStable: false,
      isShortable: true,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.1 * 10 * 1000 * 1000,
    ...
    scusd: {
      ...
      decimals: 6,
      priceFeed: "0x787d8a215bCd73c993D86189877aE28486fAc793",
      priceDecimals: 8,
      stable: true,
      tokenWeight: 4000,
      minProfitBps: 20,
    ...
    wbtc: {
      name: "wbtc",
      address: "0x0555e30da8f98308edb960aa94c0db47230d2b9c", // TODO
      decimals: 8,
      priceFeed: "0x637a78542Ce143a6BB4b3801B3b0462331D626b3",
      priceDecimals: 8,
      stable: false,
      tokenWeight: 5000,
      minProfitBps: 0,
      maxUsdgAmount: 25000, //10 * 1000 * 1000,
      bufferAmount: "5000000",
      isStable: false,
      isShortable: true,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.1 * 10 * 1000 * 1000, // 10%
  ...
  berachain: {
    honey: {
      name: "honey",
      address: "0xfcbd14dc51f0a4d49d5e53c2e0950e0bc26d0dce", // TODO
      decimals: 18,
      priceFeed: "0x406a4A676b84F90B6Bd05ae0e80c002DD5879415",
      priceDecimals: 8,
      stable: true,
      tokenWeight: 4000,
      minProfitBps: 0,
    ...
    usdc: {
      name: "usdc",
      address: "0x549943e04f40284185054145c6e4e9568c1d3241", // TODO
      decimals: 6,
      priceFeed: "0x2bfd532526BA01D15be22cb707CE844c355aeA72",
      priceDecimals: 8,
      stable: true,
      tokenWeight: 4000,
      minProfitBps: 0,
    ...
    wbera: {
      name: "wbera",
      address: "0x6969696969696969696969696969696969696969", // TODO
      decimals: 18,
      priceFeed: "0xE0E67E0D8280F4bECBa10B7C7aBb290436d16DF7",
      priceDecimals: 8,
      stable: false,
      tokenWeight: 12000,
      minProfitBps: 0,
    ...
    weth: {
      name: "weth",
      address: "0x2f6f07cdcf3588944bf4c42ac74ff24bf56e7590", // TODO
      decimals: 18,
      priceFeed: "0xA37E9f870c273205666199c11E0B640f1D665C95",
      priceDecimals: 8,
      stable: false,
      tokenWeight: 9000,
      minProfitBps: 0,
  ...
  base: {
    usdc: {
      name: "usdc",
      address: "0x833589fcd6edb6e08f4c7c32d4f71b54bda02913", // TODO
      decimals: 6,
      priceFeed: "0x406a4A676b84F90B6Bd05ae0e80c002DD5879415",
      priceDecimals: 8,
      stable: true,
      tokenWeight: 6000,
      minProfitBps: 0,
      maxUsdgAmount: 2000, // 20 * 1000 * 1000,
      bufferAmount: 0,
      isStable: true,
      isShortable: false,
      fastPricePrecision: 1000,
    ...
    weth: {
      name: "weth",
      address: "0x4200000000000000000000000000000000000006", // TODO
      decimals: 18,
      priceFeed: "0xA37E9f870c273205666199c11E0B640f1D665C95",
      priceDecimals: 8,
      stable: false,
      tokenWeight: 8000,
      minProfitBps: 0,
      maxUsdgAmount: 8000, //10 * 1000 * 1000,
      bufferAmount: 0, // 5 followed by 21 zeros as a string
      isStable: false,
      isShortable: true,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.1 * 10 * 1000 * 1000, // 10%
    ...
    cbbtc: {
      name: "cbbtc",
      address: "0xcbb7c0000ab88b473b1f5afd9ef808440eed33bf", // TODO
      decimals: 8, // Corrected from 18 based on reader output
      priceFeed: "0x2bfd532526BA01D15be22cb707CE844c355aeA72",
      priceDecimals: 8,
      stable: false,
      tokenWeight: 8000,
      minProfitBps: 0,
      maxUsdgAmount: 8000, //10 * 1000 * 1000,
      bufferAmount: 0, // Corrected raw value for 0.05 CBBTC with 8 decimals
      isStable: false,
      isShortable: true,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.1 * 10 * 1000 * 1000, // 10%
    ...
    zora: {
      name: "zora",
      address: "0x1111111111166b7fe7bd91427724b487980afc69", // TODO
      decimals: 18,
      priceFeed: "0x34ecA0877cb75FAc25d785518b3238458F82733e",
      priceDecimals: 8,
      stable: false,
      tokenWeight: 4000,
      minProfitBps: 0,
  ...
  superseed: {
    ...
    usdc: {
      ...
      tokenWeight: 25000,
      minProfitBps: 0,
      maxUsdgAmount: 50000, // 20 * 1000 * 1000,
      bufferAmount: 3000 * 1000 * 1000,
      isStable: true,
      isShortable: false,
      fastPricePrecision: 1000,
      maxCumulativeDeltaDiff: 0.1 * 10 * 1000 * 1000, // 10%
  ...
  basesepolia: {
    ...
    cbbtc: {
      name: "cbbtc",
      address: "0x529FCB9442701174a0D55D8DD536E5c3815a429B",
      decimals: 18,
      priceFeed: "0xA37E9f870c273205666199c11E0B640f1D665C95",
      priceDecimals: 8,
      fastPricePrecision: 1000,
    ...
    usdc: {
      name: "usdc",
      address: "0xF6F75Cd958CF47406715E83dBB0baC7820b2A37f",
      decimals: 18,
      priceFeed: "0x2bfd532526BA01D15be22cb707CE844c355aeA72",
      priceDecimals: 8,
      stable: true,
