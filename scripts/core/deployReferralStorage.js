...
async function main() {
  ...
  await sendTxn(referralStorage.setTier("0", "1000", "5000"), "referralStorage.setTier")
  await sendTxn(referralStorage.setTier("1", "2000", "6000"), "referralStorage.setTier")
  await sendTxn(referralStorage.setTier("2", "2700", "4444"), "referralStorage.setTier")
