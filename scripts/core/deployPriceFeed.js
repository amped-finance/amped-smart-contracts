...
async function getAvaxValues() {
  ...
  const updater1 = { address: "0x8e5de1BC43d6c0cB36E3F2A5e11dc5295662aeEC" }
  const updater2 = { address: "0x8e5de1BC43d6c0cB36E3F2A5e11dc5295662aeEC" }
  const keeper1 = { address: "0x8e5de1BC43d6c0cB36E3F2A5e11dc5295662aeEC" }
  const keeper2 = { address: "0x8e5de1BC43d6c0cB36E3F2A5e11dc5295662aeEC" }
  const updaters = [updater1.address, updater2.address, keeper1.address, keeper2.address]
...
async function getPegasusValues() {
  const { weth, btc, usdt } = tokens
  const tokenArr = [weth, btc, usdt]
  const fastPriceTokens = [weth, btc]

  const priceFeedTimelock = { address: "0x0eF606f0E226d99f284A85cbaa4D08Ec398eDD1F" }

  const updater1 = { address: "0x03413564187AD43DB5024b0E6D7E1d24b1d0bE23" }
  const updater2 = { address: "0x03413564187AD43DB5024b0E6D7E1d24b1d0bE23" }
  const keeper1 = { address: "0x03413564187AD43DB5024b0E6D7E1d24b1d0bE23" }
  const keeper2 = { address: "0x03413564187AD43DB5024b0E6D7E1d24b1d0bE23" }
  const updaters = [updater1.address, updater2.address, keeper1.address, keeper2.address]

  const tokenManager = { address: "0xC8e58Be4266e84fcC34e6d9F810e974F49C224B4" }

  const positionRouter = await contractAt("PositionRouter", "0x068e02D7f588Ff7A82Dc7E5BB38328Ecee7af7EE")
...
async function main() {
  ...
  const deployer = { address: "0x03413564187AD43DB5024b0E6D7E1d24b1d0bE23" }
  ...
  const vaultPriceFeed = await contractAt("VaultPriceFeed", "0x4b3211a5819fE5545aE8E5C36fF493898587b4eC")
