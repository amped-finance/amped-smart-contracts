...
async function main() {
  ...
  await sendTxn(alp.setMinter(alpManager.address, false), "alp.setMinter")
  await sendTxn(usdg.removeVault(alpManager.address), "usdg.removeVault")
  await sendTxn(vault.setManager(alpManager.address, false), "vault.setManager")
}
