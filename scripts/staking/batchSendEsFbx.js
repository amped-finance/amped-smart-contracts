...
const { DISTRIBUTION_LIST } = require("../../data/esAmpDistribution/distributionList1")
...
async function main() {
  ...
  await sendTxn(esAmp.approve(batchSender.address, expandDecimals(100 * 1000, 18)), "esAmp.approve")
