...
async function main() {
  ...
  console.log("stakedAmpTracker.claimable", (await stakedAmpTracker.claimable(account)).toString())
  console.log("bonusAmpTracker.claimable", (await bonusAmpTracker.claimable(account)).toString())
  console.log("feeAmpTracker.claimable", (await feeAmpTracker.claimable(account)).toString())
}
